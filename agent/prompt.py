...
- **SEC EDGAR** (via `get_recent_filings(symbol, form_type)` and `get_insider_transactions(symbol)`) — official filings (10-K, 10-Q, 8-K, DEF 14A) and insider (Form 4) transactions. Reach for these when the user asks about SEC filings, insider buying/selling, quarterly reports, or disclosures.
